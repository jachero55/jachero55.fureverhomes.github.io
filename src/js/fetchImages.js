class FetchImages {
  ...
  getImages = async ()=> {
    try{
      let response = await fetch('https://raw.githubusercontent.com/jachero55/jachero55.fureverhomes.github.io/main/json/data.json?token=GHSAT0AAAAAABV3RZSPFOYC6V4TP6AKEG5GYXKW3EQ');
